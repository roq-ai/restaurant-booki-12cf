...
interface MenuSDK {
  create: <
    ...
    U extends Omit<Prisma.menuCreateArgs, 'data'> & {
      data: Omit<Prisma.menuUncheckedCreateInput, 'order'>;
    },
  >(
  ...
  update: <
    T extends Prisma.menuUpdateArgs,
    R extends Prisma.menuGetPayload<T>,
    U extends Omit<Prisma.menuUpdateArgs, 'data'> & {
      data: Omit<Prisma.menuUncheckedUpdateInput, 'order'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
...
interface ReservationSDK {
  create: <
    ...
    U extends Omit<Prisma.reservationCreateArgs, 'data'> & {
  ...
  update: <
    ...
    U extends Omit<Prisma.reservationUpdateArgs, 'data'> & {
...
interface RestaurantSDK {
  create: <
    ...
    U extends Omit<Prisma.restaurantCreateArgs, 'data'> & {
      data: Omit<Prisma.restaurantUncheckedCreateInput, 'menu' | 'reservation' | 'table' | 'user'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
  ...
  update: <
    ...
    U extends Omit<Prisma.restaurantUpdateArgs, 'data'> & {
      data: Omit<Prisma.restaurantUncheckedUpdateInput, 'menu' | 'reservation' | 'table' | 'user'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
...
interface TableSDK {
  create: <
    ...
    U extends Omit<Prisma.tableCreateArgs, 'data'> & {
      data: Omit<Prisma.tableUncheckedCreateInput, 'reservation'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
  ...
  update: <
    T extends Prisma.tableUpdateArgs,
    R extends Prisma.tableGetPayload<T>,
    U extends Omit<Prisma.tableUpdateArgs, 'data'> & {
      data: Omit<Prisma.tableUncheckedUpdateInput, 'reservation'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
...
interface UserSDK {
  create: <
    ...
    U extends Omit<Prisma.userCreateArgs, 'data'> & {
      data: Omit<Prisma.userUncheckedCreateInput, 'order' | 'reservation'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
  ...
  update: <
    ...
    U extends Omit<Prisma.userUpdateArgs, 'data'> & {
      data: Omit<Prisma.userUncheckedUpdateInput, 'order' | 'reservation'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
...
export class RoqBaasSdk {
  ...
  private initSDK() {
    ...
    this.menu = {
      ...
      update: async function updateMenu<
        T extends Prisma.menuUpdateArgs,
        R extends Prisma.menuGetPayload<T>,
        U extends Omit<Prisma.menuUpdateArgs, 'data'> & {
          data: Omit<Prisma.menuUncheckedUpdateInput, 'order'>;
    ...
    this.table = {
      ...
      update: async function updateTable<
        T extends Prisma.tableUpdateArgs,
        R extends Prisma.tableGetPayload<T>,
        U extends Omit<Prisma.tableUpdateArgs, 'data'> & {
          data: Omit<Prisma.tableUncheckedUpdateInput, 'reservation'>;
