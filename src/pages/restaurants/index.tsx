...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'menu.count', 'reservation.count', 'table.count', 'user.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'maximum_capacity', header: 'maximum_capacity', accessorKey: 'maximum_capacity' },
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'User',
          accessorKey: 'user',
          cell: ({ row: { original: record } }: any) => record?._count?.user,
        }
      : null,
